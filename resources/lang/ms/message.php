...
return [
    ...
    "jadual_header_current" => "Jadual Waktu Pasang Surut " . now()->format('l jS \\of F Y'),
    "jadual_header_next_day" => "Jadual Waktu Pasang Surut " . now()->addDay(1)->format('l jS \\of F Y'),
    "jadual_header_3rd_day" => "Jadual Waktu Pasang Surut " . now()->addDay(2)->format('l jS \\of F Y'),
    "jadual_header_4th_day" => "Jadual Waktu Pasang Surut " . now()->addDay(3)->format('l jS \\of F Y'),
    "jadual_header_5th_day" => "Jadual Waktu Pasang Surut " . now()->addDay(4)->format('l jS \\of F Y'),
    "jadual_header_6th_day" => "Jadual Waktu Pasang Surut " . now()->addDay(5)->format('l jS \\of F Y'),
    "jadual_header_7th_day" => "Jadual Waktu Pasang Surut " . now()->addDay(6)->format('l jS \\of F Y'),
