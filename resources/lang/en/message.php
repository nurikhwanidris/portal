...
return [
    ...
    "jadual_header_current" => "Tide Schedule for " . now()->format('l jS \\of F Y'),
    "jadual_header_next_day" => "Tide Schedule for " . now()->addDay(1)->format('l jS \\of F Y'),
    "jadual_header_3rd_day" => "Tide Schedule for " . now()->addDay(2)->format('l jS \\of F Y'),
    "jadual_header_4th_day" => "Tide Schedule for " . now()->addDay(3)->format('l jS \\of F Y'),
    "jadual_header_5th_day" => "Tide Schedule for " . now()->addDay(4)->format('l jS \\of F Y'),
    "jadual_header_6th_day" => "Tide Schedule for " . now()->addDay(5)->format('l jS \\of F Y'),
    "jadual_header_7th_day" => "Tide Schedule for " . now()->addDay(6)->format('l jS \\of F Y'),
    "pasang_surut" => "Tide",
