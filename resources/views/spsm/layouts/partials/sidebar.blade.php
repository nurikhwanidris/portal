...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="/jupem/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item {{ request()->is('spsm/admin/buletingis/*') ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="/spsm/admin/buletingis/create" class="nav-link">
                                <i class="fas fa-plus nav-icon"></i>
                                <p>Tambah Buletin GIS</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/spsm/admin/buletingis/" class="nav-link">
                                <i class="fas fa-list-alt nav-icon"></i>
