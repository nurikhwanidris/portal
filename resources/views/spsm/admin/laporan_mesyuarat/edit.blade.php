...
<div class="card">
    <div class="card-body">
        <form action="/spsm/admin/laporan_mesyuarat/{{ $laporan->id }}" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        @csrf
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="title_my" id=""
                                        ...
                                        value="{{ old('title_my',$laporan->title_my) }}">
                                    @error('title_my')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="title_en" id=""
                                        ...
                                        value="{{ old('title_en',$laporan->title_en) }}">
                                    @error('title_en')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="row mb-3 d-none">
                                <label for="" class="col-form-label col-form-label-sm col-sm-1">Old File Name</label>
                                <span class="col-sm-1">:</span>
                                <div class="col-sm-2">
                                    <input type="text" name="oldFilename" id="" class="form-control form-control-sm"
                                        value="{{ $laporan->filename }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-2">
                                    <select name="status_id" id=""
                                        ...
                                        @if (old('status_id', $laporan->status_id) == $status->id)
