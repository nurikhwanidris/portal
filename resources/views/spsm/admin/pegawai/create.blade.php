                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-2">
                        <select name="gred_id" id="" class="form-control form-control-sm">
                            ...
                            <option value="1" @if (old('gred_id') == 1) selected @endif>A1</option>
                            <option value="2" @if (old('gred_id') == 2) selected @endif>A2</option>
                            <option value="3" @if (old('gred_id') == 3) selected @endif>A3</option>
                            <option value="4" @if (old('gred_id') == 4) selected @endif>A4</option>
                            <option value="5" @if (old('gred_id') == 5) selected @endif>A5</option>
                        </select>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <select name="dept_id" id="" class="form-control form-control-sm">
                            ...
                            @foreach ($jabatans as $jabatan)
                                @if (old('dept_id') == $jabatan->id)
                                    <option value="{{ $jabatan->id }}" selected>{{ $jabatan->name_my }}</option>
                                @else
