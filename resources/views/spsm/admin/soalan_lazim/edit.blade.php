...
@section('content')
    <div class="card">
        <div class="card-body">
            <form action="/spsm/admin/soalan_lazim/{{ $soalanLazim->id }}" method="post">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row">
                            @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="soalan_my" id=""
                                    ...
                                    value="{{ old('soalan_my', $soalanLazim->soalan_my) }}">
                                @error('soalan_my')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="soalan_en" id=""
                                    ...
                                    value="{{ old('soalan_en', $soalanLazim->soalan_en) }}">
                                @error('soalan_en')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control jawapan_my" id="jawapan_my" placeholder="Enter the Description" name="jawapan_my"
                                    rows="4">{{ old('jawapan_my', $soalanLazim->jawapan_my) }}</textarea>
                                @error('jawapan_my')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control jawapan_en" id="jawapan_en" placeholder="Enter the Description" name="jawapan_en"
                                    rows="4">{{ old('jawapan_en', $soalanLazim->jawapan_en) }}</textarea>
                                @error('jawapan_en')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-sm-3">
                                <select name="category_id" id="" class="form-control form-control-sm">
                                    ...
                                    @foreach ($categories as $category)
                                        @if (old('category_id', $soalanLazim->category_id) == $category->id)
