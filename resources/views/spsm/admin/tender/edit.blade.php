...
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-lg-12">
                <form action="/spsm/admin/tender/{{ $tender->id }}" method="post" enctype="multipart/form-data">
                    <div class="row">
                        @method('put')
                        @csrf
                    </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="title_my" id="" class="form-control form-control-sm"
                                        value="{{ old('title_my',$tender->title_my) }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="title_en" id="" class="form-control form-control-sm"
                                        value="{{ old('title_en', $tender->title_en) }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="tempoh" id="" class="form-control form-control-sm"
                                        value="{{ old('tempoh',$tender->tempoh) }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="taklimat" id="" class="form-control form-control-sm"
                                        value="{{ old('taklimat', $tender->taklimat) }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="pertanyaan" id="" class="form-control form-control-sm"
                                        value="{{ old('pertanyaan',$tender->pertanyaan) }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-3">
                                    <select name="status_id" id="" class="form-control form-control-sm">
                                        ...
                                        @if (old('status_id', $tender->status_id)== $status->id)
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-2">
                                    <input type="datetime-local" name="paparanMula" id=""
                                        ...
                                        value="{{ old('paparanMula',$tender->paparanMula) }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-2">
                                    <input type="datetime-local" name="paparanTamat" id=""
                                        class="form-control form-control-sm"
                                        value="{{ old('paparanTamat', $tender->paparanTamat) }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-12">
