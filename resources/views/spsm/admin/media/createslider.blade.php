                    ...
                    <div class="col-sm-6">
                        <form action="/spsm/admin/slider/save" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <small class="text-danger">Gambar mestilah menepati resolusi
                                        <strong>1400x300</strong> dan tidak
                                        melebihi <strong>1MB</strong></small>
                                    <input type="file" name="sliderImage" id="image"
                                        class="form-control form-control-sm @error('sliderImage') is-invalid @enderror"
                                        accept="image/webp, image/png, image/jpg, image/jpeg" onchange="previewImage()">
                                    @error('sliderImage')
