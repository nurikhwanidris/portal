...
<div class="card">
    <div class="card-body">
        <form action="/spsm/admin/kertas_kerja/{{ $kertasKerja->id }}" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="title_my" id=""
                                        ...
                                        value="{{ old('title_my',$kertasKerja->title_my) }}">
                                </div>
                                @error('title_my')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="title_en" id=""
                                        ...
                                        value="{{ old('title_en',$kertasKerja->title_en) }}">
                                </div>
                                @error('title_en')
                                <div class="invalid-feedback">
                                    {{ $message }}
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" name="presentedBy" id=""
                                        ...
                                        value="{{ old('presentedBy',$kertasKerja->presentedBy) }}">
                                </div>
                                @error('presentedBy')
                                <div class="invalid-feedback">
                                    {{ $message }}
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-2">
                                    <input type="file" name="filename" id=""
                                        ...
                                        <input type="text" name="oldFilename" id="" class="form-control form-control-sm d-none" value="{{ $kertasKerja->filename }}">
                                </div>
                                @error('filename')
                                <div class="invalid-feedback">
                                    {{ $message }}
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-2">
                                    <input type="date" name="date" id=""
                                        ...
                                        value="{{ old('date', $kertasKerja->date) }}">
                                </div>
                                @error('date')
                                <div class="invalid-feedback">
                                    {{ $message }}
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-2">
                                    <select name="status_id" id=""
                                        ...
                                        @if (old('status_id', $kertasKerja->status_id) == $status->id)
