...
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-lg-12">
                <form action="/spsm/admin/buletin_gis/{{ $buletinGis->id }}" method="post"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="title_my" id=""
                                        ...
                                        value="{{ old('title_my',$buletinGis->title_my) }}">
                                    @error('title_my')
                            ...
                            <div class="row mb-3">
                                <label for="" class="col-sm-2 col-form-label col-form-label-sm">buletinGis Title</label>
                                <span class="col-sm-1">:</span>
                                <div class="col-sm-6">
                                    <input type="text" name="title_en" id=""
                                        class="form-control form-control-sm @error('title_en') is-invalid @enderror"
                                        value="{{ old('title_en',$buletinGis->title_en) }}">
                                    @error('title_en')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="year" id=""
                                        ...
                                        value="{{ old('title_en',$buletinGis->year) }}">
                                    @error('year')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-2">
                                    <select name="status_id" id=""
                                        ...
                                        @if (old('status_id',$buletinGis->status_id)==$status->id)
