<div>
    ...
    <div class="row kotak-filter">
        <div class="form-group col-lg-6">
            ...
            <input class="form-control border-color-quaernary" type="text" placeholder="Title/Code"
                aria-label="default color input example" id="pertukaran-pegawai-filter-text">
        </div>
        <div class="form-group col-lg-6">
            <label class="form-label mb-1 text-2">Pilih</label>
            <div class="custom-select-1">
                <select class="form-select form-control  border-color-quaernary h-auto" name=""
                    id="pertukaran-pegawai-filter-selection" required>
                    ...
                    <option value="Bertukar Jabatan/Kementerian">Bertukar Jabatan/Kementerian</option>
    ...
    <!-- Filtering - END -->
    <!-- Datatable - START -->
    <table id="pertukaranPegawai-table" class="table table-striped table-hover" style="width:100%">
        <thead>
            <tr>
