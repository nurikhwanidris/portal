                        ...
                        <div class="card-header" id="collapse200HeadingOne">
                            <h4 class="card-title m-0">
                                <a class="accordion-toggle text-color-dark font-weight-bold collapsed"
                                    data-bs-toggle="collapse" data-bs-target="#keratan-akhbar" aria-expanded="false"
                                    aria-controls="keratan-akhbar">
                                    Keratan Akhbar
                                </a>
                            </h4>
                        </div>
                        <div id="keratan-akhbar" class="collapse" aria-labelledby="collapse200HeadingOne"
                            data-bs-parent="#accordion200">
                            <div class="card-body pt-0">
                                <div class="col">
                                    <div class="row portfolio-list sort-destination">
                                        @foreach ($keratan_akhbar as $item)
                                            <div class="col-12 col-sm-6 col-lg-3 isotope-item websites">
                                                <div class="portfolio-item">
                                                    <a
                                                        href="{{ asset('storage/upload/keratan_akhbar/' . $item->lampiran) }}">
                                                        <span class="thumb-info thumb-info-lighten border-radius-0">
                                                            <span class="thumb-info-wrapper border-radius-0">
                                                                <img src="{{ asset('storage/upload/keratan_akhbar/' . $item->gambar) }}"
