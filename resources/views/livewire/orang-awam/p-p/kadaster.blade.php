    ...
    <div class="row pb-4">
        <div class="featured-boxes featured-boxes-style-3 featured-boxes-flat">
            <div class="col mb-4 mb-lg-0">
                <!-- 1 - Pangkalan Data Ukur Kadaster (PDUK)-->
                                ...
                                <div class="toggle toggle-primary toggle-simple" data-plugin-toggle>
                                    ...
                                    <section class="toggle">
                                        {{-- <span class="toggle-title text-4">
                                            <div class="accordion-jupem-negeri">Pangkalan Data Ukur Kadaster (PDUK)</div>
                                        </span>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <a class="img-thumbnail img-thumbnail-no-borders d-block lightbox"
                                                                    href="{{ asset('main/img/produk-dan-perkhidmatan/peta/20190626114259-Untitled.jpg') }}"
                                                                    data-plugin-options="{'type':'image'}">
                                                                    <img class="img-fluid"
                                                                        src="{{ asset('main/img/produk-dan-perkhidmatan/peta/20190626114259-Untitled.jpg') }}"
                                                                        alt="Project Image">
                                                                    <span class="zoom">
                ...
                <!-- 2 - Pangkalan Data Ukur Kadaster Berdigit Kebangsaan (NDCDB) -->
                        ...
                        <div id="collapse200Two" class="collapse" aria-labelledby="collapse200HeadingTwo"
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="toggle toggle-primary toggle-simple" data-plugin-toggle>
                                    ...
                                    <section class="toggle">
                                        {{-- <span class="toggle-title text-4">
                                            <div class="accordion-jupem-negeri">Pangkalan Data Ukur Kadaster Berdigit Kebangsaan (NDCDB)</div>
                                        </span>
                                        <div class="toggle-content"> --}}
                                            <!-- SECTION + TEXT TO LEFT - START -->
                                            <div class="row align-items-center pt-4 appear-animation"
                                                ...
                                                <div class="col-md-4 mb-4 mb-md-0">
                                                    <div class="col">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <a class="img-thumbnail img-thumbnail-no-borders d-block lightbox"
                                                                    href="{{ asset('main/img/produk-dan-perkhidmatan/peta/20190626115115-Untitled.jpg') }}"
                                                                    data-plugin-options="{'type':'image'}">
                                                                    <img class="img-fluid"
                                                                        src="{{ asset('main/img/produk-dan-perkhidmatan/peta/20190626115115-Untitled.jpg') }}"
                                                                        alt="Project Image">
                                                                    <span class="zoom">
                                                                        <i class="fas fa-search"></i>
                                                                    </span>
                        ...
                        <div id="collapse200Three" class="collapse" aria-labelledby="collapse200HeadingThree"
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="toggle toggle-primary toggle-simple" data-plugin-toggle>
                                    ...
                                    <section class="toggle">
                                        {{-- <span class="toggle-title text-4">
                                            <div class="accordion-jupem-negeri">Pelan Akui (PA)</div>
                                        </span>
                                        <div class="toggle-content"> --}}
                                            <!-- SECTION + TEXT TO LEFT - START -->
                                            <div class="row align-items-center pt-4 appear-animation"
                                                ...
                                                <div class="col-md-4 mb-4 mb-md-0">
                                                    <div class="col">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <a class="img-thumbnail img-thumbnail-no-borders d-block lightbox"
                                                                    href="{{ asset('main/img/produk-dan-perkhidmatan/peta/20190403120030-30e8e-pa_cth.jpg') }}"
                                                                    data-plugin-options="{'type':'image'}">
                                                                    <img class="img-fluid"
                                                                        src="{{ asset('main/img/produk-dan-perkhidmatan/peta/20190403120030-30e8e-pa_cth.jpg') }}"
                                                                        alt="Project Image">
                                                                    <span class="zoom">
                                                                        <i class="fas fa-search"></i>
                                                                    </span>
                                                ...
                                                <div class="col-md-4 mb-4 mb-md-0">
                                                    <div class="col">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <a class="img-thumbnail img-thumbnail-no-borders d-block lightbox"
                                                                    href="{{ asset('main/img/produk-dan-perkhidmatan/peta/20190626131525-Untitled.jpg') }}"
                                                                    data-plugin-options="{'type':'image'}">
                                                                    <img class="img-fluid"
                                                                        src="{{ asset('main/img/produk-dan-perkhidmatan/peta/20190626131525-Untitled.jpg') }}"
                                                                        alt="Project Image">
                                                                    <span class="zoom">
                                                                        <i class="fas fa-search"></i>
                                                                    </span>
                                                ...
                                                <div class="col-md-4 mb-4 mb-md-0">
                                                    <div class="col">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <a class="img-thumbnail img-thumbnail-no-borders d-block lightbox"
                                                                    href="{{ asset('main/img/produk-dan-perkhidmatan/peta/20190403121251-db73d-standardsheet.jpg') }}"
                                                                    data-plugin-options="{'type':'image'}">
                                                                    <img class="img-fluid"
                                                                        src="{{ asset('main/img/produk-dan-perkhidmatan/peta/20190403121251-db73d-standardsheet.jpg') }}"
                                                                        alt="Project Image">
                                                                    <span class="zoom">
                                                                        <i class="fas fa-search"></i>
                                                                    </span>
