        ...
        <div class="row pt-2">
            ...
            <div class="col-lg-9">
                ...
                <div class="row" style="margin-top: 30px;">
                    <h2 class="font-weight-bold text-4 mb-0"> {{ $bahagianPegawai[0]->deptName }}</h2>
                </div>
                ...
                <div class="row" style="margin-top: 10px;">
                    <div class="col-md-5 order-md-2 mb-4 mb-lg-0 appear-animation"
                        ...
                        @if ($bahagianPegawai[0]->name_my == 'KOSONG')
                ...
                <aside class="sidebar">
                    ...
                    <ul class="nav nav-list flex-column mb-5">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#">Seksyen Pembangunan
                                Kompetensi</a></li>
                        <li class="nav-item"><a class="nav-link" href="#">Seksyen Pengurusan
                                Korporat</a>
                        </li>
