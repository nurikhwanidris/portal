<div>
    <div class="container pt-3 pb-2" style="margin-bottom: 100px;">
        <div class="row pt-2">
            ...
            <div class="row">
                <div class="col">
                    <div class="text-title-semasa-11" style="padding-bottom: 20px;">Direktori Pegawai</div>
                </div>
            </div>

            <!-- Column Left - START -->
            <div class="col-lg-9">
                <!-- <h2 class="font-weight-normal text-7 mb-2"><strong class="font-weight-extra-bold">Direktori</strong> Pegawai</h2> -->

                <!-- Dropdown Bahagian - START -->
                <div class="row">
                    <div class="featured-boxes featured-boxes-style-3 featured-boxes-flat">
                        <div class="row">
                            <div>
                                <span>Bahagian</span>
                                <select wire:model='bahagian' class="form-select form-select-sm"
                                    aria-label=".form-select-sm example">
                                    <option value="1" class="department_dropdown_option">PEJABAT KETUA PENGARAH UKUR DAN
                                        PEMETAAN MALAYSIA</option>
                                    <option value="2" class="department_dropdown_option">PEJABAT TIMBALAN KETUA PENGARAH
                                        UKUR DAN PEMETAAN I</option>
                                    <option value="3" class="department_dropdown_option">PEJABAT TIMBALAN KETUA PENGARAH
                                        UKUR DAN PEMETAAN II</option>
                                    <option value="5" class="department_dropdown_option">BAHAGIAN DASAR DAN PENYELARASAN
                                        PEMETAAN</option>
                                    ...
                                    <option value="16" class="">Seksyen Perkhidmatan Geo-Dataraya</option>
                                    <option value="14" class="">Seksyen Teknikal Geospatial Pertahanan
                                    </option>
                                    <option value="17" class="">Seksyen Pembangunan Keupayaan</option>
                                    <option value="91" class="">Seksyen Keselamatan dan Keupayaan Sistem
                                    </option>
                                    <option value="92" class="">Seksyen Dasar dan Penyelarasan Geospatial
                                        Pertahanan</option>
                                    ...
                                    <option value="20" class="">Seksyen Sempadan Negeri dan Penyelarasan
                                    </option>
                                    ...
                                    <option value="26" class="">Seksyen Perkhidmatan Geospatial</option>
                                    ...
                                    <option value="33" class="">Seksyen Pentadbiran dan Kewangan</option>
                                    <option value="31" class="">Seksyen Data Geospatial</option>
                                    <option value="30" class="">Seksyen Penerbitan Peta Digital</option>
                                    ...
                                    <option value="35" class="">Seksyen Naziran dan Pembangunan Pangkalan
                                        Data</option>
                                    ...
                                    <option value="42" class="department_dropdown_option">BAHAGIAN PERANCANGAN DAN
                                        KORPORAT</option>
                                    <option value="46" class="">Seksyen Inovasi Dan Dokumentasi</option>
                                    ...
                                    <option value="47" class="">Seksyen Penyelarasan Pembangunan</option>
                                    ...
                                    <option value="56" class="">Pejabat Topografi Wilayah Kuantan</option>
                                    <option value="55" class="">Pejabat Topografi Wilayah Segamat</option>
                                    <option value="54" class="">Pejabat Topografi Wilayah Taiping</option>
                                    <option value="60" class="">Seksyen Fotogrametri</option>
                                    <option value="58" class="">Seksyen Pangkalan Data Topografi</option>
                                    ...
                                    <option value="76" class="">Seksyen Pangkalan Data Topografi</option>
                                    <option value="74" class="">Pejabat Topografi Wilayah Kuching</option>
                                    ...
                                    <option value="86" class="department_dropdown_option">JUPEM NEGERI SEMBILAN</option>
                ...
                <!-- Dropdown Bahagian - END -->

                <!-- Search Nama Pegawai - START -->
                <div class="row">
                    <div style="margin-top: 10px;">
                        Nama
                        <div class="input-group rounded">
                            <input type="search" class="form-control rounded" placeholder="Sila taip nama pegawai"
                ...
                <div class="row pb-0 pt-3 mb-5 appear-animation" data-appear-animation="fadeInUpShorter"
                    ...
                    {{-- <div class="col-sm-6 col-lg-4 mb-4 mb-lg-0">
                        <span class="thumb-info thumb-info-hide-wrapper-bg thumb-info-no-zoom">
                            <span class="thumb-info-wrapper">
                                <a href="about-me.html">
                                    <img src="img/anggota/pegawai/khairi.jpg" class="img-fluid" alt="">
                                </a>
                            </span>
                            <span class="thumb-info-caption">
                                <ul class="list list-icons list-icons-style-2 list-icons-sm mt-2 appear-animation ul-kite"
                                    data-appear-animation="maskUp" data-appear-animation-delay="300">
                                    <h4 class="font-weight-bold mb-2 size-text-standard">3. AHMAD KHAIRI BIN ABD. MALIK
                                    </h4>
                                    <h2 class="font-weight-bold mb-0 pt-0 mt-0 size-text-standard-2">
                                        Penolong Pengarah
                                    </h2>
                                    <li class="li-kite">
                                        <i class="fas fa-envelope top-6"></i>
                                        <strong>Email:</strong><br>
                                        <a href="mailto:?">ahmad.khairi@jupem.gov.my</a>
                                    </li>
                                    <li class="li-kite">
                                        <i class="fas fa-phone top-6"></i>
                                        <strong>Tel:</strong><br>
                    ...
                    <div class="col-sm-6 col-lg-4 mb-4 mb-lg-0">
                        <span class="thumb-info thumb-info-hide-wrapper-bg thumb-info-no-zoom">
                            ...
                            <span class="thumb-info-caption">
                                <h3 class="font-weight-extra-bold text-color-dark text-4 line-height-1 mt-3 mb-0">4.
                                    KOSONG</h3>
                                <span class="text-2 mb-0">Penolong Pengarah</span>
                                <span class="thumb-info-caption-text pt-1"><i class="icon-envelope icons"></i> -
                                </span>
                                <span class="thumb-info-caption-text pt-1"><i class="icon-phone icons"></i> 03-2617
                                    0885</span>
                                <span class="thumb-info-caption-text pt-1"><i class="icon-envelope-letter icons"></i>
                                    03-2617 0990</span>
                            </span>
                        </span>
                    </div>
                    <div class="col-sm-6 col-lg-4 mb-4 mb-lg-0">
                        <span class="thumb-info thumb-info-hide-wrapper-bg thumb-info-no-zoom">
                            <span class="thumb-info-wrapper">
                                <a href="about-me.html">
                                    <img src="img/anggota/pegawai/haizul.jpg" class="img-fluid" alt="">
                                </a>
                            </span>
                            <span class="thumb-info-caption">
                                <h3 class="font-weight-extra-bold text-color-dark text-4 line-height-1 mt-3 mb-0">5.
                                    HAIZUL BIN ABDUL HALIM</h3>
                                <span class="text-2 mb-0">Penolong Pengarah</span>
                                <span class="thumb-info-caption-text pt-1"><i class="icon-envelope icons"></i>
                                    haizul@jupem.gov.my</span>
                                <span class="thumb-info-caption-text pt-1"><i class="icon-phone icons"></i> 03-2617
                                    0887</span>
                                <span class="thumb-info-caption-text pt-1"><i class="icon-envelope-letter icons"></i>
                                    03-2617 0990</span>
                    ...
                    <div class="col-sm-6 col-lg-4 mb-4 mb-lg-0">
                        <span class="thumb-info thumb-info-hide-wrapper-bg thumb-info-no-zoom">
                            <span class="thumb-info-wrapper">
                                <a href="about-me.html">
                                    <img src="img/anggota/pegawai/yazid.jpg" class="img-fluid" alt="">
                                </a>
                            </span>
                            <span class="thumb-info-caption">
                                <h3 class="font-weight-extra-bold text-color-dark text-4 line-height-1 mt-3 mb-0">6.
                                    ABU
                                    YAZID BIN SALAM</h3>
                                <span class="text-2 mb-0">Penolong Pegawai Teknologi Maklumat</span>
                                <span class="thumb-info-caption-text pt-1"><i class="icon-envelope icons"></i>
                                    abuyazid@jupem.gov.my</span>
                                <span class="thumb-info-caption-text pt-1"><i class="icon-phone icons"></i> 03-2617
                                    0889</span>
                                <span class="thumb-info-caption-text pt-1"><i class="icon-envelope-letter icons"></i>
                                    03-2617 0990</span>
                    ...
                    <div class="col-sm-6 col-lg-4 mb-4 mb-lg-0">
                        <span class="thumb-info thumb-info-hide-wrapper-bg thumb-info-no-zoom">
                            <span class="thumb-info-wrapper">
                                <a href="about-me.html">
                                    <img src="img/anggota/pegawai/roziana.jpg" class="img-fluid" alt="">
                                </a>
                            </span>
                            <span class="thumb-info-caption">
                                <h3 class="font-weight-extra-bold text-color-dark text-4 line-height-1 mt-3 mb-0">7.
                                    ROZIANA BT RAMLEE</h3>
                                <span class="text-2 mb-0">Penolong Pegawai Teknologi Maklumat</span>
                                <span class="thumb-info-caption-text pt-1"><i class="icon-envelope icons"></i>
                                    roziana.ramlee@jupem.gov.my</span>
                                <span class="thumb-info-caption-text pt-1"><i class="icon-phone icons"></i> 03-2617
                                    0659</span>
                                <span class="thumb-info-caption-text pt-1"><i class="icon-envelope-letter icons"></i>
                                    03-2617 0990</span>
                    ...
                    <div class="col-sm-6 col-lg-4 mb-4 mb-lg-0">
                        <span class="thumb-info thumb-info-hide-wrapper-bg thumb-info-no-zoom">
                            <span class="thumb-info-wrapper">
                                <a href="about-me.html">
                                    <img src="img/anggota/pegawai/mukhlis.jpg" class="img-fluid" alt="">
                                </a>
                            </span>
                            <span class="thumb-info-caption">
                                <h3 class="font-weight-extra-bold text-color-dark text-4 line-height-1 mt-3 mb-0">8.
                                    MUKHLIS BIN BASIR</h3>
                                <span class="text-2 mb-0">Penolong Pegawai Teknologi Maklumat</span>
                                <span class="thumb-info-caption-text pt-1"><i class="icon-envelope icons"></i>
                                    mukhlis@jupem.gov.my</span>
                                <span class="thumb-info-caption-text pt-1"><i class="icon-phone icons"></i> 03-2617
                                    0696</span>
                                <span class="thumb-info-caption-text pt-1"><i class="icon-envelope-letter icons"></i>
                                    03-2617 0990</span>
                    ...
                    <div class="col-sm-6 col-lg-4 mb-4 mb-lg-0">
                        <span class="thumb-info thumb-info-hide-wrapper-bg thumb-info-no-zoom">
                            <span class="thumb-info-wrapper">
                                <a href="about-me.html">
                                    <img src="img/anggota/pegawai/bad.jpg" class="img-fluid" alt="">
                                </a>
                            </span>
                            <span class="thumb-info-caption">
                                <h3 class="font-weight-extra-bold text-color-dark text-4 line-height-1 mt-3 mb-0">9.
                                    MOHAMED BADHUSHAH BIN MOHAMED SHARIFF</h3>
                                <span class="text-2 mb-0">Penolong Pegawai Teknologi Maklumat</span>
                                <span class="thumb-info-caption-text pt-1"><i class="icon-envelope icons"></i>
                                    badhushah@jupem.gov.my</span>
                                <span class="thumb-info-caption-text pt-1"><i class="icon-phone icons"></i> 03-2617
                                    0596</span>
                                <span class="thumb-info-caption-text pt-1"><i class="icon-envelope-letter icons"></i>
                                    03-2617 0990</span>
                    ...
                    <div class="col-sm-6 col-lg-4 mb-4 mb-lg-0">
                        <span class="thumb-info thumb-info-hide-wrapper-bg thumb-info-no-zoom">
                            <span class="thumb-info-wrapper">
                                <a href="about-me.html">
                                    <img src="img/anggota/pegawai/zohde.jpg" class="img-fluid" alt="">
                                </a>
                            </span>
                            <span class="thumb-info-caption">
                                <h3 class="font-weight-extra-bold text-color-dark text-4 line-height-1 mt-3 mb-0">10.
                                    AHMAD ZOHDE BIN ABDUL SAMAD</h3>
                                <span class="text-2 mb-0">Penolong Pegawai Teknologi Maklumat</span>
                                <span class="thumb-info-caption-text pt-1"><i class="icon-envelope icons"></i>
                                    ahmadzohde@jupem.gov.my</span>
                                <span class="thumb-info-caption-text pt-1"><i class="icon-phone icons"></i> 03-2617
                                    0631</span>
                                <span class="thumb-info-caption-text pt-1"><i class="icon-envelope-letter icons"></i>
                                    03-2617 0990</span>
            ...
            <div class="col-lg-3 mt-4 mt-lg-0">
                <aside class="sidebar">
                    ...
                    <ul class="nav nav-list flex-column mb-5">
                        <li class="nav-item"><a class="nav-link" href="#">Seksyen Inovasi Dan
                                Dokumentasi</a></li>
                        <!--
                        <li class="nav-item">
                        ...
                        -->
                        <li class="nav-item"><a class="nav-link" href="#">Seksyen Pembangunan
                                Kompetensi</a></li>
                        <li class="nav-item"><a class="nav-link" href="#">Seksyen Pengurusan Korporat</a>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="#">Seksyen Pengurusan Sistem
                                Maklumat</a></li>
                        <li class="nav-item"><a class="nav-link" href="#">Seksyen Penyelarasan
                                Pembangunan</a></li>
                        <li class="nav-item"><a class="nav-link" href="#">Seksyen Perancangan Dan
                                Dasar</a></li>
                    </ul>
                </aside>
            </div>
