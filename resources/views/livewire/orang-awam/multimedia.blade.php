...
<div class="row">
	<div class="col">
		<div class="text-title-semasa-11" style="padding-bottom: 20px;">Multimedia</div>
	</div>
</div>
<!-- PAGE TITLE - END-->
<div class="row pb-4">
									...
									<div id="collapse200TwoA" class="collapse" aria-labelledby="collapse200HeadingTwoA" data-bs-parent="#accordion200">
										<div class="card-body pt-0">
											...
											<div>
												...
												<p class="mb-0 para-align-title">Cerapan Gerhana Matahari Separa di JUPEM Negeri - 21 Jun 2020</p>
												<p class="mb-0 para-align">17 gambar</p>
												<div class="para-gap"></div>
												<!-- Tajuk Album - END -->
												<!-- GALLERY 2 - START -->
											...
											<div>
												<!-- Tajuk Album - START -->
												<div class="para-gap"></div>
												<p class="mb-0 para-align-title">Lawatan Kerja YB Timbalan Menteri Tenaga dan Sumber Asli (KeTSA) ke JUPEM - 4 Mei 2020</p>
												<p class="mb-0 para-align">7 gambar</p>
												<div class="para-gap"></div>
												<!-- Tajuk Album - END -->
												<!-- GALLERY 2 - START -->
												<div class="lightbox" data-plugin-options="{'delegate': 'a', 'type': 'image', 'gallery': {'enabled': true}, 'mainClass': 'mfp-with-zoom', 'zoom': {'enabled': true, 'duration': 300}}">
											...
											<div>
												<!-- Tajuk Album - START -->
												<div class="para-gap"></div>
												<p class="mb-0 para-align-title">Lawatan Kerja YB Menteri Tenaga dan Sumber Asli (KeTSA) ke JUPEM - 9 April 2020</p>
												<p class="mb-0 para-align">6 gambar</p>
												<div class="para-gap"></div>
												<!-- Tajuk Album - END -->
												<!-- GALLERY 2 - START -->
												<div class="lightbox" data-plugin-options="{'delegate': 'a', 'type': 'image', 'gallery': {'enabled': true}, 'mainClass': 'mfp-with-zoom', 'zoom': {'enabled': true, 'duration': 300}}">
