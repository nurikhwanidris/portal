							...
							<aside class="sidebar">
								...
								<!-- <div class="tabs tabs-vertical tabs-right tabs-navigation tabs-navigation-simple"> -->
									...
									<ul class="nav nav-tabs col-sm-3">
										...
										<li class="nav-item">
											<a class="nav-link" href="#tab-2" data-bs-toggle="tab">Pertukaran Pegawai</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="#tab-3" data-bs-toggle="tab">Laporan Mesyuarat</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="#tab-4" data-bs-toggle="tab">Inovasi Sektor Awam</a>
										</li>
										<li class="nav-item">
										...
										<li class="nav-item">
											<a class="nav-link" href="#tab-8" data-bs-toggle="tab">Garis Panduan Umum</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="#tab-9" data-bs-toggle="tab">Dasar dan Pekeliling</a>
										</li>
										<li class="nav-item">
