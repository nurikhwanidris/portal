    ...
    <div class="row">
        <div class="col-md-12">
            <marquee behaviour="scroll" onmouseover="this.stop();" onmouseout="this.start();" direction="left"
                ...
                <a href="#" style="color: #000 !important;"><strong class="text-title-strong">Pengumumam 1 :
                    </strong>Penerangan Pengumumam 1</a>
                <span class="dot-grey"></span>
                <a href="#" style="color: #000 !important;"><strong class="text-title-strong">Pengumumam 2 :
                    </strong>Penerangan Pengumumam 2</a>
                <span class="dot-grey"></span>
                <a href="#" style="color: #000 !important;"><strong class="text-title-strong">Pengumumam 3 :
                    </strong>Penerangan Pengumumam 3</a>
            </marquee>
        </div>
    </div>
</div>
