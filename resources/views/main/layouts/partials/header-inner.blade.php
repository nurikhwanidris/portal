<header id="header" style="background-color: #212529 !important;"  data-plugin-options="{'stickyEnabled': true, 'stickyEffect': 'shrink', 'stickyEnableOnBoxed': true, 'stickyEnableOnMobile': false, 'stickyChangeLogo': true, 'stickyStartAt': 20, 'stickyHeaderContainerHeight': 100}">
										...
										<li class="item">
											<div class="product-details">
												...
												<p class="product-name">
													<a href="#"><img src="/main/img/shortcut-icon/my.svg" alt="BM" class="header-nav-top-icon-img flag-w3c"> </a>
													<a href="#"><img src="/main/img/shortcut-icon/gb.svg" alt="ENG" class="header-nav-top-icon-img flag-w3c"> </a>
												</p>
											</div>
										</li>
									</ol>
									...
									<ol class="mini-products-list">
										<li class="item">
											<div class="product-details">
												...
												<p class="product-name">
													<a href="#">
														<img src="/main/img/shortcut-icon/manual-colour.svg" alt="Manual" class="header-nav-top-icon-img manual" style="height: 40px;">
													</a>
												</p>
											</div>
										</li>
