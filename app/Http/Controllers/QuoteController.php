...
class QuoteController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/spsm/admin/quote')->with('success', 'Satu tender telah berjaya disimpan dan akan mula dipaparkan pada ' . $validateData['show']);
    }
    ...
    public function update(Request $request, Quote $quote)
    {
        ...
        return redirect('/spsm/admin/quote')->with('success', 'Satu sebut harga telah berjaya dikemaskini dan akan mula dipaparkan pada ' . $validateData['show']);
    }
